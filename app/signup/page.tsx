        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold text-gray-900 mb-4">
              Get Started with Bright Advance Co
            </h1>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          {submitStatus === 'success' ? (
            ...
            <>
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Sign Up for Bright Advance Co</h2>
                  ...
                  <div className="bg-[#3b3a41] text-white rounded-lg p-6">
                    <div className="flex items-start">
                      ...
                      <label htmlFor="call-consent" className="ml-3 text-sm leading-relaxed">
                        By checking this box, you provide consent to receive automated customer care calls from Bright Advance Co. Call frequency varies and standard phone rates may apply. You may opt-out at any time by contacting support@brightadvanceco.com. Consent is not required as a condition of purchasing any products or services.
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-300 rounded-lg p-6">
                    <div className="flex items-start">
                      ...
                      <label htmlFor="account-notifications" className="ml-3 text-sm leading-relaxed text-gray-700">
                        By checking this box, you consent to receive account notifications, service updates, and important information about your Bright Advance Co account via email and SMS. You may opt-out at any time by contacting support@brightadvanceco.com or by following the unsubscribe instructions in our communications. Consent is not required as a condition of purchasing any products or services.
                      </label>
                    </div>
                  </div>
